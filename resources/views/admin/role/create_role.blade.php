                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" name="name" value="{{ old('name') }}" required placeholder="Enter Your name">
                    </div>
                    <div class="form-group col-md-4">
                      <label>Employee Email<span class="text-danger">*</span></label>
                      <input type="email" name="email" value="{{ old('email') }}" required class="form-control" placeholder="Enter Your Email Address"> 
                    </div>
                    <div class="form-group col-md-4">
                      <label>Password<span class="text-danger">*</span></label>
                      <input type="password" name="password" value="{{ old('password') }}" required class="form-control" placeholder="Enter password"> 
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-3">
