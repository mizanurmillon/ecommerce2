	...
	<div class="single_product">
		<div class="container">
			<div class="row">
                ...
                <div class="product_price" style="margin-top: 20px; font-size: 15px;">{{ $setting->currency }}{{ $product->selling_price }}</div>
                @else
                <div class="product_price" style="margin-top: 20px; font-size: 15px;">
				...
				<div class="col">
					...
					<div class="viewed_slider_container">
						...
						<div class="owl-carousel owl-theme viewed_slider">
			                ...
			                <div class="viewed_price" style="margin-top: 20px; font-size: 15px;">{{ $setting->currency }}{{ $row->selling_price }}</div>
			                @else
			                <div class="viewed_price" style="margin-top: 20px; font-size: 15px;">
