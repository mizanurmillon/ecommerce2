...
class HomeController extends Controller
{
    ...
    public function index()
    {
        if (!Auth::user()->is_admin==1) {
            $order=DB::table('orders')->where('user_id',Auth::id())->orderBy('id','DESC')->take(10)->get();
            //total order
            ...
            return view('home',compact('order','total_order','complete_order','cancel_order','return_order'));
        }else{
